<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="GardenDetails.aspx.cs" Inherits="GardenDetails" %>
        ...
        <div id="product-box1">
            <div id="product-box1-right">
                <ul id="important-info">
                    ...
                    <li>
                        <br />
                        <asp:Button ID="btnReserve" runat="server" Text="مشاهده سرویس ها و ثبت رزرو" Width="100%" Enabled="false" />
                    </li>
                </ul>

            </div>
            <div id="product-box1-left">
