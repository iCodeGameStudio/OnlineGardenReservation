<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Accounts/AccountSignin.aspx.cs" Inherits="Accounts_AccountSignin" %>
...
<head runat="server">
    ...
    <title>ورود به مدیریت باغ</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container" style="display: none; transform: matrix(0, 0, 0, 0, 0, 0); left: 0px;">
            <h1>ورود به مدیریت باغ</h1>
            <span class="close-btn">
                <img src="../Login/images/close.png">
            </span>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtemail" runat="server" placeholder="آدرس ایمیل" ValidationGroup="vgsignup"></asp:TextBox>
                    <asp:TextBox ID="txtpass" runat="server" placeholder="گذرواژه" TextMode="Password" ValidationGroup="vgsignup"></asp:TextBox>
                    <asp:Button ID="btnsign" runat="server" Text="ورود" OnClick="Button1_Click" ValidationGroup="vgsignup" />
                </ContentTemplate>
            </asp:UpdatePanel>
            ...
            <div id="divsignup">
                <a class="signup" href="AccountSignup">هنوز ثبت نام نکرده ام</a>
            </div>
        </div>
    ...
    <script type="text/javascript" src="../Login/JS/JavaScript.js"></script>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None" ControlToValidate="txtemail" ValidationGroup="vgsignup"></asp:RequiredFieldValidator>
