...
public partial class Admin_ManagementPayments : System.Web.UI.Page
{
    ...
    {
        ((HtmlGenericControl)Page.Master.FindControl("treepage")).InnerHtml = "<li><a href='ManagementHome'><i class='fa fa-dashboard'></i>خانه</a></li>   <li class='active'>تراکنش ها</li>";
    }
    ...
    private void setPayments()
    {
        ...
        GridView1.DataSource = dba.getPayments();
        GridView1.DataBind();
    }
