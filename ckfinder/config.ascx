...
<script runat="server">
    public override Boolean CheckAuthentication()
    {
        //if (UTLSessions.isNull("management"))
        //{
        //    System.Data.DataTable dt = UTLCookies.getCookie("management");
        //    if (dt.Rows.Count == 1)
        //    {
        //        String email = dt.Rows[0]["value-a"].ToString();
        //        String password = dt.Rows[0]["value-b"].ToString();
        //        DBAUsers dba = new DBAUsers();
        //        String result = dba.loginCheck(email, password);
        //        if (result == "0")
        //        {
        //            return false;
        //        }
        //        else
        //        {
        //            UTLSessions.setSession("management", result);
        //            return true;
        //        }
        //    }
        //    else
